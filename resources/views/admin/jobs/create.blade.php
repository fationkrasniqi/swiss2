<x-admin-layout title="{{ __('admin.create_new_job') }}">
    <div class="mb-6">
        <a href="{{ route('admin.jobs.index') }}" class="text-blue-600 hover:text-blue-800">&larr; {{ __('admin.back_to_list') }}</a>
    </div>

    <div class="rounded-xl bg-white p-6 shadow-sm">
        <h1 class="text-2xl font-bold text-gray-900">{{ __('admin.create_new_job') }}</h1>
        ...
        <form action="{{ route('admin.jobs.store') }}" method="POST" class="mt-6 space-y-6">
            ...
            {{-- English Fields --}}
            <div id="content-en" class="tab-content space-y-5">
                <div>
                ...
                <div>
                    ...
                    <textarea name="description_en" id="description_en" rows="6"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('description_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="requirements_en" id="requirements_en" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('requirements_en') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="we_offer_en" id="we_offer_en" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('we_offer_en') }}</textarea>
                    @error('we_offer_en')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            {{-- German Fields --}}
            <div id="content-de" class="tab-content hidden space-y-5">
                <div>
                ...
                <div>
                    ...
                    <textarea name="description_de" id="description_de" rows="6"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('description_de') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="requirements_de" id="requirements_de" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('requirements_de') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="we_offer_de" id="we_offer_de" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('we_offer_de') }}</textarea>
                    @error('we_offer_de')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            {{-- Albanian Fields --}}
            <div id="content-sq" class="tab-content hidden space-y-5">
                <div>
                    <label for="title_sq" class="block text-sm font-medium text-gray-700">Titulli (Shqip)</label>
                    <input type="text" name="title_sq" id="title_sq" value="{{ old('title_sq') }}"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                    @error('title_sq')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                ...
                <div>
                    ...
                    <textarea name="description_sq" id="description_sq" rows="6"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('description_sq') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="requirements_sq" id="requirements_sq" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('requirements_sq') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="we_offer_sq" id="we_offer_sq" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('we_offer_sq') }}</textarea>
                    @error('we_offer_sq')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            {{-- French Fields --}}
            <div id="content-fr" class="tab-content hidden space-y-5">
                <div>
                ...
                <div>
                    ...
                    <textarea name="description_fr" id="description_fr" rows="6"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('description_fr') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="requirements_fr" id="requirements_fr" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('requirements_fr') }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="we_offer_fr" id="we_offer_fr" rows="4"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">{{ old('we_offer_fr') }}</textarea>
                    @error('we_offer_fr')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                ...
                <div>
                    ...
                    <select name="employment_type" id="employment_type"
                        class="mt-1 block w-full rounded-lg border border-gray-300 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500">
                        <option value="">{{ __('admin.opt_select') }}</option>
                        <option value="Full-time" {{ old('employment_type') == 'Full-time' ? 'selected' : '' }}>{{ __('admin.opt_fulltime') }}</option>
                        <option value="Part-time" {{ old('employment_type') == 'Part-time' ? 'selected' : '' }}>{{ __('admin.opt_parttime') }}</option>
                        <option value="Contract" {{ old('employment_type') == 'Contract' ? 'selected' : '' }}>{{ __('admin.opt_contract') }}</option>
                        <option value="Temporary" {{ old('employment_type') == 'Temporary' ? 'selected' : '' }}>{{ __('admin.opt_temporary') }}</option>
                    </select>
