<x-admin-layout title="Job Details">
    ...
    <div class="rounded-xl bg-white p-6 shadow-sm">
        ...
        <div class="space-y-4">
            <div>
                ...
                <p class="mt-1">
                    @if($job->is_active)
                        <span class="inline-flex rounded-full bg-green-100 px-3 py-1 text-sm font-semibold text-green-800">Active</span>
                    @else
                        <span class="inline-flex rounded-full bg-gray-100 px-3 py-1 text-sm font-semibold text-gray-800">Inactive</span>
                    @endif
                </p>
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-gray-900">{{ $job->location ?? 'N/A' }}</p>
            </div>
    ...
    <div class="mt-6 rounded-xl bg-white p-6 shadow-sm">
        <h2 class="mb-4 text-xl font-bold text-gray-900">Recent Applications</h2>
